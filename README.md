...
- **Angular 15+ Compatible**: This package supports Angular version 15 and above with ng-recaptcha v11 compatibility, ensuring that your app stays up to date with the latest Angular features.
